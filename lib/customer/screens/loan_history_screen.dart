...
class _LoanHistoryScreenState extends State<LoanHistoryScreen> {
  ...
  final List<String> _filters = ['All', 'Active', 'Pending', 'Completed', 'Rejected'];
  ...
  List<Loan> get _filteredLoans {
    if (_selectedFilter == 'All') {
      ...
      return _allLoans.where((loan) => loan.status == 'Approved').toList();
    } else {
      return _allLoans.where((loan) => loan.status == _selectedFilter).toList();
    }
  }
